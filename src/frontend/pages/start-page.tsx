...
export const StartPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-[10px]">
      <ProgressLogo />
      <div className="text-white text-base font-bold uppercase select-none">
        Download Eternum Data
      </div>
        ...
        <ButtonLike
          onClick={() => {
            window.electronAPI.sendMessage(
              IpcMethod.StartTorii,
              selectedConfig.toLowerCase(),
            );
